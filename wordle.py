...
while(True):
    ...
    filter_list = input("Enter KNOWN letters with KNOWN spaces with '?' acting as placeholder for UNKNOWN letters separated by commas (e.g. '?,p,p,?,?' for what is likely 'apple'):\n").lower().split(",")
